...
export function OrderTrack({
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {!admin && order.state === "LABEL_ISSUED" && (
        <div className="card mt-6 border-brand-300 p-6">
          <h2 className="text-lg font-bold">Shipped your device?</h2>
          <p className="mt-1 text-sm text-ink-500">
            Print your prepaid label, pack the device, and drop it off at any carrier location.
            Then let us know it's on the way.
          </p>
      ...
      {!admin && CUSTOMER_HINTS[order.state] && (
